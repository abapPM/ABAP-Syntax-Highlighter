CLASS ltcl_abapgit_syntax_abap DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    DATA:
     mo_cut TYPE REF TO zcl_highlighter_abap.
...
CLASS ltcl_syntax_basic_logic DEFINITION FINAL FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    DATA mo_syntax_highlighter TYPE REF TO zcl_highlighter_abap.
...
CLASS ltcl_syntax_basic_logic IMPLEMENTATION.
  ...
  METHOD apply_style.
    ...
    lv_line_act = mo_syntax_highlighter->apply_style(
      ...
      iv_class = zcl_highlighter_abap=>c_css-keyword ).
...
CLASS ltcl_syntax_cases DEFINITION FINAL FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    DATA:
      mt_after_parse  TYPE zcl_highlighter_abap=>ty_match_tt,
      mt_after_order  TYPE zcl_highlighter_abap=>ty_match_tt,
      mt_after_extend TYPE zcl_highlighter_abap=>ty_match_tt.
...
CLASS ltcl_syntax_cases IMPLEMENTATION.
  ...
  METHOD do_test.
    ...
    DATA: lt_matches_act TYPE zcl_highlighter_abap=>ty_match_tt,
          ls_match       LIKE LINE OF lt_matches_act,
          lv_offs        TYPE i,
          lo_syntax      TYPE REF TO zcl_highlighter_abap.
  ...
  METHOD generate_parse.
    DATA ls_match TYPE zcl_highlighter_abap=>ty_match.
